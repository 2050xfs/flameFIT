        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-right duration-500">
            ...
            <div className="relative h-64 bg-stone-900 rounded-b-3xl -mx-4 -mt-4 md:rounded-3xl md:mx-0 md:mt-0 p-8 flex flex-col justify-end overflow-hidden">
                ...
                <div className="relative z-20 text-white">
                    <button onClick={onBack} className="absolute top-[-140px] left-0 p-2 bg-black/20 backdrop-blur-md rounded-full text-white hover:bg-black/40 transition-colors">
                        ← Back
                    </button>
            ...
            <div className="sticky top-4 z-40">
                <button
                    onClick={onStart}
                    className="w-full py-4 bg-orange-500 hover:bg-orange-600 text-white rounded-2xl font-bold text-lg shadow-xl shadow-orange-500/20 transition-transform active:scale-[0.98] flex items-center justify-center gap-2"
                >
            ...
            <div className="space-y-4 pb-8">
                ...
                {workout.exercises.map((ex, i) => (
                    <div key={i} className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 p-5 rounded-2xl flex items-center gap-5">
                        ...
                        <button className="p-3 text-stone-300 hover:text-stone-500 transition-colors">
                            ℹ️
                        </button>
                    </div>
                ))}
