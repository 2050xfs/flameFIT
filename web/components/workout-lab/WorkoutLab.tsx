                ...
                {todaysWorkout ? (
                    ...
                    <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-3xl p-12 text-center">
                        ...
                        <div className="flex gap-3 justify-center">
                            <button className="px-6 py-3 bg-stone-100 dark:bg-stone-800 hover:bg-stone-200 dark:hover:bg-stone-700 text-stone-900 dark:text-white rounded-xl font-medium transition-colors">
                                Browse Library
                            </button>
