        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <section>
                <div className="flex items-center justify-between mb-6">
                    ...
                    <button className="text-sm text-orange-500 hover:text-orange-600 font-medium font-mono hover:underline">View Details →</button>
                </div>
                    ...
                    <div className="space-y-8">
                        {timeline.map((item, index) => (
                            <div key={item.id} className="group flex gap-6 relative">
                                ...
                                {/* Content Card */}
                                <div className="flex-1 bg-stone-50 dark:bg-stone-800/50 rounded-2xl p-5 hover:bg-white dark:hover:bg-stone-800 border border-transparent hover:border-stone-200 dark:hover:border-stone-700 shadow-sm hover:shadow-md transition-all">
